...
queue-and-send surface, never to a chat library or an HTTP framework, so
a future transport — or the hub itself — slots in without touching
anything upstream.
"""
...
__all__ = ["DiscordLink", "RemoteUnavailable", "WebLink", "WebIndicator"]
